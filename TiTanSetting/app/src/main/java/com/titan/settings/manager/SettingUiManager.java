package com.titan.settings.manager;
...
import com.titan.settings.main.MainView;
import com.titan.settings.picture.PictureParamView;
import com.titan.settings.sound.SoundEffectView;
...
public class SettingUiManager {
    ...
    public void hideSetting() {
        LogUtils.d("Function Start");
        isShow = false;
        if (mDecorView != null && mWindowManager != null) {
