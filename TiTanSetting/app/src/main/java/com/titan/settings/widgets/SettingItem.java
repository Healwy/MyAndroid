...
public class SettingItem extends RelativeLayout implements Selectable {
    ...
    public SettingItem(Context context, boolean useDefaultLayout) {
        super(context);
        if (useDefaultLayout) {
            inflate(context, R.layout.setting_item_content, this);
            setFocusable(true);
    ...
    public static SettingItem createItem(Context context, ViewGroup parent) {
        ...
        View out = inflate(context, R.layout.setting_item, group);
        if (group == null) {
    ...
    public void onSelecterEnter() {
        ...
        if (!(this.mTitle == null || this.keepValueColor)) {
            this.mTitle.setTextColor(getResources().getColor(R.color.setting_item_title_focused));
        }
        if (!(this.mValue == null || this.keepValueColor)) {
            this.mValue.setTextColor(getResources().getColor(R.color.setting_item_title_focused));
        }
        if (this.mDesc != null) {
            this.mDesc.setTextColor(getResources().getColor(R.color.setting_item_summary_focus));
        }
    ...
    public void onSelectorLeave() {
        ...
        if (!(this.mTitle == null || this.keepValueColor)) {
            this.mTitle.setTextColor(getResources().getColor(R.color.setting_item_title_normal));
        }
        if (!(this.mValue == null || this.keepValueColor)) {
            this.mValue.setTextColor(getResources().getColor(R.color.setting_item_title_normal));
        }
        if (this.mDesc != null) {
            this.mDesc.setTextColor(getResources().getColor(R.color.setting_item_summary_normal));
        }
        View view = findViewById(R.id.title);
        if (this.mRightArrow != null) {
